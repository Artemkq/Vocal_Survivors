...
public class PlayerInventory : MonoBehaviour
{
    ...
    public List<UpgradeUI> upgradeUIOptions = new List<UpgradeUI>(); //List of upgrade options present in the scene
    ...
    void ApplyUpgradeOptions()
    {
        ...
        foreach (UpgradeUI upgradeOption in upgradeUIOptions)
        {
            ...
            if (upgradeType == 1)
            {
                ...
                if (chosenWeaponUpgrade != null)
                {
                    ...
                    for (int i = 0; i < weaponSlots.Count; i++)
                    {
                        ...
                        {
                            //If the weapon is alredy at the max level, do not allow upgrade
                    ...
                    //If the code gets here, it means tht we will be adding a new weapon, instead of
                    ...
                    if (!isLevelUp)
                    {
                        ...
                        upgradeOption.upgradeDescriptionDisplay.text = chosenWeaponUpgrade.baseStats.description; //Apply inizial desctription
            ...
            {
                //NOTE: We have to recode this system, as right now it disables an upgrade slot
                //we hit a weapon that has alredy reached max level
                ...
                if (chosenPassiveUpgrade != null)
                {
                    ...
                    //hook an event listener to the button that will level up the weapon
                    //When this upgrade option is clecked
                    bool isLevelUp = false;
