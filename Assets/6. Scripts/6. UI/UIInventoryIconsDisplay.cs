...
public class UIInventoryIconsDisplay : MonoBehaviour
{
    ...
    public void Refresh()
    {
        ...
        for (int i = 0; i < items.Count; i++)
        {
            ...
            //Otherwise lets print a warning so that our users set this component up properly
            if (i >= slots.Length)
            {
                Debug.LogWarning(
                    string.Format(
            ...
            if (iconObj)
            {
                ...
                //If the item doesnt exist, make the icon transparent
            ...
            if (levelObj)
            {
                //Find the Text component and put the lvel inside
