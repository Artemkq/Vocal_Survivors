...
public class UIUpgradeWindow : MonoBehaviour
{
    ...
    //There are the paths to the different UI elements in the <upgradeOptionTemplate>
    [Header("Paths")]
    ...
    //These are private variables that are used by the funcions to track the status
    // of different things in the UIUpgradeWindow
    RectTransform rectTransform; //The RectTrasform of this element for easy reference
    ...
    public void SetUpgrades(PlayerInventory inventory, List<ItemData> possibleUpgrades, int pick = 3, string tooltip = "")
    {
        ...
        //If we dont have enough upgrade option boxes, create them
    ...
    //We are doing this manually because the VerticalLayoutGroup doesnt always
    ...
    //It wiil automatically search for a GameObject called "Upgrade Option" and assign
