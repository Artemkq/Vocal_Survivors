...
public class UIInventoryIconDisplayEditor : Editor
{
    ...
    //UIInventoryIconsDisplay compontn. The function scans the PlayerInventory
    ...
    private void OnEnable()
    {
        ...
        targetedItemListIndex = Math.Max(0, Array.IndexOf(itemListOptions, display.targetItemList));
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            display.targetItemList = itemListOptions[targetedItemListIndex].ToString();
    ...
    void RegenerateIcons()
    {
        ...
        if(display.slots.Length >  0)
        {
            ...
            foreach (GameObject g in display.slots)
            {
                ...
                //Otherwise remove it and record it as an indoable action
