...
public class UICharacterSelectorEditor : Editor
{
    ...
    void OnEnable()
    {
        //Point to the UICharacterSelector when its in the inspector so its variables can be accessed
        selector = target as UICharacterSelector;
    }

    public override void OnInspectorGUI()
    {
        //Create a button in the inspector with the name, that creates the toggles templates when clicked
        base.OnInspectorGUI();
    ...
    public void CreateTogglesForCharacterData()
    {
        ...
        //Loop through all the children of the parent of the toggles template
        ...
        for (int i = 0; i < characters.Length; i++)
        {
            ...
            {
                tog = Instantiate(selector.toggleTemplate, selector.toggleTemplate.transform.parent); //Create a toggle of the current character as a child of the original template parent
