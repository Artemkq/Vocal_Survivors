...
public class EnemySpawner : MonoBehaviour
{
    ...
    [Header("Spawn Positions")] public List<Transform> relativeSpawnPoints; //A list to store all the relative spawn points of enemies
    ...
    void SpawnEnemies()
    {
        ...
        {
            //Spawn each type of enemy until the quota is felled
            foreach (var enemyGroup in waves[currentWaveCount].enemyGroups)
            {
