...
public class InventoryManager : MonoBehaviour
{
            ...
            if (upgradeType == 1)
            {
                ...
                if (chosenWeaponUpgrade != null)
                {
                    ...
                    for (int i = 0; i < weaponSlots.Count; i++)
                    {
                        if (weaponSlots[i] != null && weaponSlots[i].weaponData == chosenWeaponUpgrade.weaponData)
                        {
                            ...
                            if (!newWeapon)
                            {
                                ...
                                upgradeOption.upgradeDesctiptionDisplay.text = chosenWeaponUpgrade.weaponData.NextLevelPrefab.GetComponent<WeaponController>().weaponData.Desctription;
                    ...
                    if (newWeapon) //Spawn a new weapon
                    {
                        ...
                        upgradeOption.upgradeDesctiptionDisplay.text = chosenWeaponUpgrade.weaponData.Desctription;
            ...
            else if (upgradeType == 2)
            {
                ...
                if (chosenPassiveItemUpgrade != null)
                {
                    ...
                    for (int i = 0; i < passiveItemSlots.Count; i++)
                    {
                        if (passiveItemSlots[i] != null && passiveItemSlots[i].passiveItemData == chosenPassiveItemUpgrade.passiveItemData)
                        {
                            ...
                            if (!newPassiveItem)
                            {
                                ...
                                //Set the description and name to be that of the next level
                                upgradeOption.upgradeDesctiptionDisplay.text = chosenPassiveItemUpgrade.passiveItemData.NextLevelPrefab.GetComponent<PassiveItem>().passiveItemData.Desctription;
                    ...
                    if (newPassiveItem) //Spawn a new passive item
                    {
                        ...
                        //Apply initial description and name
                        upgradeOption.upgradeDesctiptionDisplay.text = chosenPassiveItemUpgrade.passiveItemData.Desctription;
    ...
    void RemoveUpgradeOptions()
    {
        foreach (var upgradeOption in upgradeUIOptions)
        {
            ...
            DisableUpgradeUI(upgradeOption); //Call the DisableUpgrade here to disable all UI options before apllying upgrades to them
        }
    }
