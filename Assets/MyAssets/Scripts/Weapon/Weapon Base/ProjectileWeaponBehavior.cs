...
public class ProjectileWeaponBehavior : MonoBehaviour
{
    ...
    protected virtual void OnTriggerEnter2D(Collider2D col)
    {
        ...
        if (col.CompareTag("Enemy"))
        {
            ...
            enemy.TakeDamage(GetCurrentDamage(), transform.position); //Make sure to use currentDamage instead of weaponData.damage in case any damage multiplers in the future
            ReducePierce();
        }
