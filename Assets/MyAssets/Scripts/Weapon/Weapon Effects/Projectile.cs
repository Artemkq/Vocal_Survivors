...
/// <summary>
/// Component that you attach to all projectile prefabs. All spawned projectiles will fly in the direction the are facing and deal damage when they hit an object
/// </summary>
...
public class Projectile : WeaponEffect
{
    ...
    public virtual void AcquireAutoAimFacing()
    {
        ...
        EnemyStats[] targets = FindObjectsByType<EnemyStats>(FindObjectsSortMode.None); //SEE FIRST VIDEO
    ...
    {
        //Only drive movement ourselves of this is a kinematic
    ...
    protected virtual void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (es)
        {
            //If there is and owner, and the damage source is set to owner
